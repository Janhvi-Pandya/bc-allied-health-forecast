...
Explore the data yourself with filters and drill-downs in the [Interactive Shiny Dashboard](https://janhvi-pandya.shinyapps.io/bc-allied-health-forecast/).
:::
...
*Built with R (tidyverse, broom, scales) and Quarto. Source code on [GitHub](https://github.com/Janhvi-Pandya/bc-allied-health-forecast).*
